...
export const SEQUENCER_MIDI_OUT_CHANGED =
  "SC_REDUX_SEQUENCERS-SEQUENCER_MIDI_OUT_CHANGED";
export const SEQUENCER_PROP_CHANGE_QUEUED =
  "SC_REDUX_SEQUENCERS-SEQUENCER_PROP_CHANGE_QUEUED";
export const SEQUENCER_PROP_CHANGED =
  "SC_REDUX_SEQUENCERS-SEQUENCER_PROP_CHANGED";
